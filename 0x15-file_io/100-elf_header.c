 ...
 * @e_ident: pointing to an array containing the ELF magic num.
 ...
 * @e_ident: pointint to an array containing the ELF magic num.
 ...
 * @e_ident: pointing to an array containing ELF class.
 */
 ...
 * @e_ident: pointings to an array containing ELF ABI version.
 */
 ...
 * @e_ident: A pointing to an array containing ELF class.
 */
...
/**
 * main – Display info contained in ELF header at start of an ELF file.
